...
fun ByteBuffer.asList(): List<Byte> {
    return object : AbstractList<Byte>(), RandomAccess {
        override val size get() = this@asList.lim
...
fun ShortBuffer.asList(): List<Short> {
    return object : AbstractList<Short>(), RandomAccess {
        override val size: Int get() = this@asList.lim
        override fun isEmpty(): Boolean = isEmpty()
...
val ByteBuffer.lastIndex get() = lim - 1

/** Returns the last valid index for the buffer. */
val ShortBuffer.lastIndex get() = lim - 1

/** Returns the last valid index for the buffer. */
val IntBuffer.lastIndex get() = lim - 1

/** Returns the last valid index for the buffer. */
val LongBuffer.lastIndex get() = lim - 1

/** Returns the last valid index for the buffer. */
val FloatBuffer.lastIndex get() = lim - 1

/** Returns the last valid index for the buffer. */
val DoubleBuffer.lastIndex get() = lim - 1

/** Returns the last valid index for the buffer. */
val CharBuffer.lastIndex get() = lim - 1
...
fun ByteBuffer.toByteArray() = ByteArray(lim) { get(it) }

/** Returns a buffer of Char containing all of the elements of this generic buffer. */
fun CharBuffer.toCharArray() = CharArray(lim) { get(it) }

/** Returns a buffer of Double containing all of the elements of this generic buffer. */
fun DoubleBuffer.toDoubleArray() = DoubleArray(lim) { get(it) }

/** Returns a buffer of Float containing all of the elements of this generic buffer. */
fun FloatBuffer.toFloatArray() = FloatArray(lim) { get(it) }

/** Returns a buffer of Int containing all of the elements of this generic buffer. */
fun IntBuffer.toIntArray() = IntArray(lim) { get(it) }

/** Returns a buffer of Long containing all of the elements of this generic buffer. */
fun LongBuffer.toLongArray() = LongArray(lim) { get(it) }

/** Returns a buffer of Short containing all of the elements of this generic buffer. */
fun ShortBuffer.toShortArray() = ShortArray(lim) { get(it) }

/** Returns a *typed* object buffer containing all of the elements of this primitive buffer. */
fun ByteBuffer.toTypedArray() = Array(lim) { get(it) }

/** Returns a *typed* object buffer containing all of the elements of this primitive buffer. */
fun ShortBuffer.toTypedArray() = Array(lim) { get(it) }

/** Returns a *typed* object buffer containing all of the elements of this primitive buffer. */
fun IntBuffer.toTypedArray() = Array(lim) { get(it) }

/** Returns a *typed* object buffer containing all of the elements of this primitive buffer. */
fun LongBuffer.toTypedArray() = Array(lim) { get(it) }

/** Returns a *typed* object buffer containing all of the elements of this primitive buffer. */
fun FloatBuffer.toTypedArray() = Array(lim) { get(it) }

/** Returns a *typed* object buffer containing all of the elements of this primitive buffer. */
fun DoubleBuffer.toTypedArray() = Array(lim) { get(it) }

/** Returns a *typed* object buffer containing all of the elements of this primitive buffer. */
fun CharBuffer.toTypedArray() = Array(lim) { get(it) }
