...
inline fun ShortArray.toBuffer(): ByteBuffer = Buffer(size * 2).also { for (i in 0 until size) it.putShort(i * 2, get(i)) }
...
inline fun IntArray.toBuffer(): ByteBuffer = Buffer(size * 4).also { for (i in 0 until size) it.putInt(i * 4, get(i)) }
inline fun IntArray.toByteBuffer(): ByteBuffer = toBuffer()
inline fun IntArray.toIntBuffer(): IntBuffer = IntBuffer(size) { get(it) }

inline fun LongArray.toBuffer(): ByteBuffer = Buffer(size * 8).also { for (i in 0 until size) it.putLong(i * 8, get(i)) }
inline fun LongArray.toByteBuffer(): ByteBuffer = toBuffer()
inline fun LongArray.toLongBuffer(): LongBuffer = LongBuffer(size) { get(it) }

inline fun FloatArray.toBuffer(): ByteBuffer = Buffer(size * 4).also { for (i in 0 until size) it.putFloat(i * 4, get(i)) }
...
inline fun DoubleArray.toBuffer(): ByteBuffer = Buffer(size * 8).also { for (i in 0 until size) it.putDouble(i * 8, get(i)) }
...
inline fun ShortArray.toBuffer(stack: MemoryStack): ByteBuffer = stack.Buffer(size * 2).also { for (i in 0 until size) it.putShort(i * 2, get(i)) }
...
inline fun IntArray.toBuffer(stack: MemoryStack): ByteBuffer = stack.Buffer(size * 4).also { for (i in 0 until size) it.putInt(i * 4, get(i)) }
...
inline fun LongArray.toBuffer(stack: MemoryStack): ByteBuffer = stack.Buffer(size * 8).also { for (i in 0 until size) it.putLong(i * 8, get(i)) }
...
inline fun FloatArray.toBuffer(stack: MemoryStack): ByteBuffer = stack.Buffer(size * 4).also { for (i in 0 until size) it.putFloat(i * 4, get(i)) }
...
inline fun DoubleArray.toBuffer(stack: MemoryStack): ByteBuffer = stack.Buffer(size * 8).also { for (i in 0 until size) it.putDouble(i * 8, get(i)) }
