...
class Transformations {
    ...
    fun take() {
        ...
        chars.take(3) shouldPrint "abc"
        chars.takeWhile { it < 'f' } shouldPrint "abcde"
        chars.takeLast(2) shouldPrint "yz"
        chars.takeLastWhile { it > 'w' } shouldPrint "xyz"
    }
    ...
    fun drop() {
        val chars = charBufferOf('a'..'z')
        chars.drop(23) shouldPrint "xyz"
        chars.dropLast(23) shouldPrint "abc"
